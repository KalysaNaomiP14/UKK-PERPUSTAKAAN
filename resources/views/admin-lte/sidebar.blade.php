 <aside class="main-sidebar sidebar-light-danger elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="/adminlte/dist/img/log1.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/adminlte/dist/img/Prof.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
